import { View, Text, StyleSheet, Dimensions, Image, Touchable, Share } from 'react-native'
...
const Page = () => {
    ...
    const imageAnimatedStyle = useAnimatedStyle(() => {
        return {
           transform: [
            {
                translateY: interpolate( //'map values to a different range'
                    scrollOffset.value, //dependant on this
                    [-IMG_HEIGHT, 0, IMG_HEIGHT], //input range
                    [-IMG_HEIGHT / 2, 0, IMG_HEIGHT * 0.75] // output range
                ) //scrolls less than image height, then uses overscroll when scrolling up
            },
            {
                scale: interpolate(
                    scrollOffset.value,
